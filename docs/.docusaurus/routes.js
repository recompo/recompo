    ...
    routes: [
      {
        ...
        component: ComponentCreator("/docs/Components/Button", "e9e"),
        exact: true,
        sidebar: "tutorialSidebar"
      },
      {
        path: "/docs/Components/Container",
        component: ComponentCreator("/docs/Components/Container", "505"),
        exact: true,
        sidebar: "tutorialSidebar"
      },
      {
        path: "/docs/Components/Typography",
        component: ComponentCreator("/docs/Components/Typography", "4de"),
        exact: true,
        sidebar: "tutorialSidebar"
      },
      {
